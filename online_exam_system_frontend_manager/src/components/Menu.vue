    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item ">
        <router-link class="menu-link" :to="{
          ...
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="Analytics">Môn học</div>
        </router-link>
        <!-- <a href="index.html" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="Analytics">Dashboard</div>
      ...
      <li class="menu-item ">
        <router-link class="menu-link" :to="{
          ...
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="Analytics">Học kỳ</div>
        </router-link>
        <!-- <a href="index.html" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="Analytics">Dashboard</div>
      ...
      <li class="menu-item " :class="{ active: route.name == 'QuestionSubmitCode' || route.name == 'QuestionQuiz' }">
        ...
        <ul class="menu-sub">
          <li class="menu-item" :class="{ active: subject._id == route.query.id }"
            v-for="(subject, index) in get_all_subjects" :key="subject._id">
            

           <router-link class="menu-link" :class="{active: route.name =='QuestionSubmitCodeBankAll' }"
