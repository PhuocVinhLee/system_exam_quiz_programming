                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Cấu trúc dữ liệu giải thuật</span>
                ...
                <div class=" col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Lập trình căn bản</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Công nghệ web</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Lý thuyết đồ thị</span>
...
onMounted(()=>{
    action_all_study_class(route.query.id);
});
