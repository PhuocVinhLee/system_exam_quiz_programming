            ...
            <div class="table-responsive text-nowrap mt-2" style="min-height: 300px;">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(one_exam_submit_code, index) in all_result_exam_submit_codes_local" :key="one_exam_submit_code._id">
                            ...
                            <td>
                                ...
                                <span v-if="one_exam_submit_code.completed == true || one_exam_submit_code.datetime_completed"
                            ...
                            <td>{{ Number((time_distance(one_exam_submit_code.datetime_completed, one_exam_submit_code.datetime_attempts
