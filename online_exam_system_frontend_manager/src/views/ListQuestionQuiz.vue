                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                        ...
                        <div class="table-responsive text-nowrap">
                            ...
                            <div v-else-if="get_lenght_question_quiz <= 0"> Khong co cau hoi</div>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu p-2 " style="width: 500px;">
                                                    <span
                                                        v-html="question_quiz_bank.question_quiz_describe"></span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <td>
                                            ...
                                            <button @click="add_one_question(question_quiz_bank._id)" type="button" class="btn btn-icon btn-outline-primary">
                            ...
                            <Pagination :lenght="get_lenght_question_quiz" @page="emit_page"></Pagination> <!-- chan trang -->
                        </div>

                        <div class="toast-container position-fixed bottom-0 end-0 me-4"
                            v-show="state_exam_quiz">
...
const { action_add_id_question_exam_submitcode, action_one_exam_quiz,action_all_exam_quizs, reset_state_exam_quiz, action_delete_exam_quiz } = useExam_quizStore();
...
watch(route, async () => {
    ...
    if (route.params.id_question_bank == 'all') {
        await action_all_question_quizs_by_teacher(route.params.id_subject, route.query.page);
        ...
        if (get_one_question_quiz_bank.value.list_question) {
            ...
            list_question.value = await get_one_question_quiz_bank.value.list_question.filter((question_id, index) => {
        ...
        await action_list_question_quiz_by_question_bank(list_question.value,get_one_question_quiz_bank.value.list_question);
    }
