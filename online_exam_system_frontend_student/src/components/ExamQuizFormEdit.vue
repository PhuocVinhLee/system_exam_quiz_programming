...
const productFormSchema = yup.object().shape({
    ...
    // lang: yup
    //     .string().
    //     when("exam_quiz_type", (val, schema) => {
    //         if (val == "submitcode") {  //if exam_quiz_type exist then apply required else not
    ...
    //   exam_quiz_wait: yup.number().typeError("Vui lòng điền vào số").notRequired()
