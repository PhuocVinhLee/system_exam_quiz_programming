                        ...
                        <tr v-for="(one_exam_submit_code, index) in all_result_exam_submit_codes_local"
                            ...
                            <span >View</span> 
                                ...
                                <router-link class="btn-group" :to="{
                                   ...
                                   params: {id_result: one_exam_submit_code._id,id_exam: route.params.id_exam, id_courses: route.params.id_courses}
                                }" >
...
const { action_all_result_exam_submitcodes,action_all_result_exam_submitcode, action_all_result_exam_submitcodes_by_teacher, action_update_result_exam_submitcodes, action_one_result_exam_submitcodes, action_add_result_exam_submitcodes } = useResult_exam_submitcodeStore();
