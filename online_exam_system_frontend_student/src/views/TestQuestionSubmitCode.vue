                ...
                <pane>
                    <span>
                        <div class=" rounded-1 bg-codemiroor text-white p-2 overflow-scroll-y "
                            ...
                            <div class="mb-3" v-if="one_question_submit_code_local.image_name">
                                <img  style="height: 300; width: 700;"  :src="`http://localhost:3000/files/`+one_question_submit_code_local.image_name" alt="" srcset="">
                            </div>
