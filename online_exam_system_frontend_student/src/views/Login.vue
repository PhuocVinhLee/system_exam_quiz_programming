          ...
          <div class="card-body">
            ...
            <Form @submit="submit()" :validation-schema="userFormSchema" v-slot="{ errors }" id="formAuthentication"
              ...
              <div class="mb-3">
                ...
                <Field type="text" v-model="student.student_id" class="form-control" @keyup ="state_login = false"
                  :class="{ ' is-valid': !errors.student_id && student.student_id }"
                  v-bind:class="{ 'is-invalid': errors.student_id || state_login.message }" name="student_id" />
                  <ErrorMessage name="student_id" class="invalid-feedback" />
