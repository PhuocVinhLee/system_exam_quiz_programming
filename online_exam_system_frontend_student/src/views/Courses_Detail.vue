...
<template>
            ...
            <div class="card p-3 m-4 mb-0" style=" background-color: rgb(252, 248, 244);">
                <h3>{{ get_one_study_class.study_class_title }}</h3>
                <h5> Giáo viên: {{ get_one_teacher.username }}</h5>
            </div>
...
Hình ảnh của danh sách đặc như hình sau:
                        ...
                        <div class="card mx-4 mb-4 px-3 bg-label-primary " v-for="active in topic.list_active">
                            ...
                            <span class="d-flex flex-row justify-content-between  align-items-center">
                                <router-link :to="{
                                    ...
                                    v-if="active.type == 'exam_submit_code'">
                                ...
                                }" v-else-if="active.type == 'exam_quiz'"
                                    class="d-flex flex-row align-items-center">
                                    <!-- <i class='bx bxs-file-pdf' style="font-size: 50px;"></i> -->
                                    <i class='bx bx-edit' style="font-size: 50px;"></i>
                ...
                Các em xem slide này trước để ngày mai cô vào sẽ giải thích sau nhé.
                            ...
                            <p class="card-text"><small class="text-muted">Lần cuối cùng cập nhật {{
                                active.create_at }}</small>
                            </p>
                        </div>
                ...
                Các em xem slide này trước để ngày mai cô vào sẽ giải thích sau nhé.
                    ...
                    <div class="card mb-3 " style=" background-color: rgb(250, 245, 240);">
                        <div class="card-body">
                            <h5 class="card-title">Chủ đề 2</h5>
                            <p class="card-text">
                        ...
                        <div class="text-center "><img class="card-img-bottom w-25 " style="height: 200px;"
                                src="../assets/img/elements/1.jpg" alt="Card image cap"></div>
...
const { get_one_study_class, study_classs, one_study_class, state_study_class } = storeToRefs(useStudy_classStore());
...
onMounted(async () => {
    await action_all_topics(route.params.id_courses)
    await action_one_study_class(route.params.id_courses);
    action_one_teacher(get_one_study_class.value.teacher_id)
