    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="">
                ...
                <!-- <h4 v-if="1" class="fw-bold py-3 "><span>{{  }}</span> {{ get_one_question_quiz_bank.question_quiz_bank_title }}
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item ">
                            <router-link type="button" class="nav-link " :class="{
                                active: route.name == 'QuestionQuizBankDetailDashboard' || route.name == 'TopicAdd'
    ...
    params: { id_question_bank: route.params.id_question_bank }
                        ...
                        <li class="nav-item">
                            <router-link type="button" class="nav-link "
                                :class="{ active: route.name == 'QuestionQuizBankDetailMember' }" :to="{
...
const { get_one_question_quiz_bank, get_all_question_quiz_banks, one_question_quiz_bank, lenght, state_question_quiz_bank } = storeToRefs(useQuestion_quiz_bankStore());
