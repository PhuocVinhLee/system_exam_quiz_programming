...
//ExamQuizResultDetail
const path = computed(() => { return (route.name == 'Test_submit_code' || route.name == 'ExamQuizResultDetail' || route.name == 'ExamSubmitcodeResultDetail' ||route.name == 'TestQuestionSubmitCode' || route.name == 'QuestionSubmitCodeAdd' || route.name == 'TestQuestionQuiz') })
const path_login = computed(() => {
  return (route.name == 'login'||  route.name == 'ExamQuizResultDetail' || route.name == 'TestQuestionSubmitCode'|| route.name == 'ExamSubmitcodeResultDetail' ||  route.name == 'LoginTeacher' || route.name == 'QuestionSubmitCodeAdd' || route.name == 'Test_submit_code'
