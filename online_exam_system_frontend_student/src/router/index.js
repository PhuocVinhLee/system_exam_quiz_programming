...
const routes = [
    {
        path: "/exam-submitcode-result-detail/:id_result/:id_exam/:id_courses",
        name: "ExamSubmitcodeResultDetail",
        component: () => import("@/views/ExamSubmitcodeResultDetail.vue"),

    },
    {
        path: "/exam-quiz-result-detail/:id_result/:id_exam/:id_courses",
        name: "ExamQuizResultDetail",
        component: () => import("@/views/ExamQuizResultDetail.vue"),
    ...
    {
        path: "/courses-attend/:id_courses",
        name: "CoursesAttend",
        component: () => import("@/views/CoursesAttend.vue"),
    ...
    {
        path: "/join-courses/:id_courses",
        name: "JoinCourses",
        component: () => import("@/views/JoinCourses.vue"),


    },
    {
        path: "/courses_detail/:id_courses",
        name: "Courses_Detail",
        component: () => import("@/views/Courses_Detail.vue"),


    },
    {
        path: "/test-question-submitcode-dashboard/:id_exam/:id_courses",
        name: "TestQuestionSubmitcodeDashboard",
        component: () => import("@/views/TestQuestionSubmitcodeDashboard.vue"),
