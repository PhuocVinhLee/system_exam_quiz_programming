...
var require_brace_fold = __commonJS({
  "node_modules/codemirror/addon/fold/brace-fold.js"(exports2, module2) {
    (function(mod) {
      ...
      function bracketFolding(pairs) {
        return function(cm, start) {
          ...
          function findOpening(pair) {
            var tokenType;
            for (var at2 = start.ch, pass = 0; ; ) {
              var found2 = at2 <= 0 ? -1 : lineText.lastIndexOf(pair[0], at2 - 1);
              if (found2 == -1) {
                if (pass == 1)
                  break;
                pass = 1;
              ...
              if (pass == 1 && found2 < start.ch)
                break;
              tokenType = cm.getTokenTypeAt(CodeMirror3.Pos(line, found2 + 1));
          ...
          function findRange(found2) {
            ...
            outer:
              for (var i2 = line; i2 <= lastLine; ++i2) {
                ...
                for (; ; ) {
                  ...
                  if (pos == text.length)
                    break;
                  if (cm.getTokenTypeAt(CodeMirror3.Pos(i2, pos + 1)) == found2.tokenType) {
                    if (pos == nextOpen)
                      ++count;
                    else if (!--count) {
                      end = i2;
            ...
            if (end == null || line == end)
              return null;
            return {
              from: CodeMirror3.Pos(line, startCh),
              to: CodeMirror3.Pos(end, endCh)
            };
          }
          var found = [];
      ...
      CodeMirror3.registerHelper("fold", "brace", bracketFolding([["{", "}"], ["[", "]"]]));
      CodeMirror3.registerHelper("fold", "brace-paren", bracketFolding([["{", "}"], ["[", "]"], ["(", ")"]]));
      CodeMirror3.registerHelper("fold", "import", function(cm, start) {
        function hasImport(line) {
          if (line < cm.firstLine() || line > cm.lastLine())
            return null;
          var start2 = cm.getTokenAt(CodeMirror3.Pos(line, 1));
          if (!/\S/.test(start2.string))
            start2 = cm.getTokenAt(CodeMirror3.Pos(line, start2.end + 1));
          if (start2.type != "keyword" || start2.string != "import")
            return null;
          for (var i = line, e = Math.min(cm.lastLine(), line + 10); i <= e; ++i) {
            var text = cm.getLine(i), semi = text.indexOf(";");
            if (semi != -1)
              return { startCh: start2.end, end: CodeMirror3.Pos(i, semi) };
          }
        }
        var startLine = start.line, has2 = hasImport(startLine), prev;
        if (!has2 || hasImport(startLine - 1) || (prev = hasImport(startLine - 2)) && prev.end.line == startLine - 1)
          return null;
        for (var end = has2.end; ; ) {
          var next = hasImport(end.line + 1);
          if (next == null)
            break;
          end = next.end;
        }
        return { from: cm.clipPos(CodeMirror3.Pos(startLine, has2.startCh + 1)), to: end };
      });
      CodeMirror3.registerHelper("fold", "include", function(cm, start) {
        ...
        var startLine = start.line, has2 = hasInclude(startLine);
        ...
        return {
          from: CodeMirror3.Pos(startLine, has2 + 1),
          to: cm.clipPos(CodeMirror3.Pos(end))
        };
      });
    });
  }
...
var require_foldcode = __commonJS({
  "node_modules/codemirror/addon/fold/foldcode.js"(exports2, module2) {
    (function(mod) {
      if (typeof exports2 == "object" && typeof module2 == "object")
        mod(require_codemirror());
      else if (typeof define == "function" && define.amd)
      ...
      function doFold(cm, pos, options, force) {
        ...
        CodeMirror3.signal(cm, "fold", cm, range2.from, range2.to);
      }
...
var require_foldgutter = __commonJS({
  "node_modules/codemirror/addon/fold/foldgutter.js"(exports2, module2) {
    (function(mod) {
      if (typeof exports2 == "object" && typeof module2 == "object")
...
var require_javascript = __commonJS({
  "node_modules/codemirror/mode/javascript/javascript.js"(exports2, module2) {
    (function(mod) {
      if (typeof exports2 == "object" && typeof module2 == "object")
        mod(require_codemirror());
      else if (typeof define == "function" && define.amd)
...
// node_modules/vue3-code-mirror/index.js
...
import "F:/HK1_2023/LV_CNTT/online_exam_system_frontend_student/node_modules/codemirror/addon/fold/foldgutter.css";
import "F:/HK1_2023/LV_CNTT/online_exam_system_frontend_student/node_modules/codemirror/lib/codemirror.css";
import "F:/HK1_2023/LV_CNTT/online_exam_system_frontend_student/node_modules/codemirror/theme/dracula.css";
...
// node_modules/native-event-bus/index.js
var EventBus = class {
  constructor(description = "") {
    __publicField(this, "eventTarget");
    this.eventTarget = typeof document === "object" ? document.appendChild(document.createComment(description)) : new EventTarget();
  }
...
// node_modules/theme-helper/index.js
var bus = new EventBus("theme-change");
var theme = document.documentElement.classList.contains("theme-white") ? "white" : "black";
var $theme = {
  get() {
    return theme;
  },
...
// node_modules/vue3-component-base/reflect-metadata.js
var Reflect2;
(function(Reflect3) {
  (function(factory) {
    var root2 = typeof global === "object" ? global : typeof self === "object" ? self : typeof this === "object" ? this : Function("return this;")();
    ...
    function GetIterator(obj) {
      var method2 = GetMethod(obj, iteratorSymbol);
      if (!IsCallable(method2))
        throw new TypeError();
      var iterator = method2.call(obj);
        ...
        function() {
          ...
          MapIterator2.prototype.next = function() {
            ...
            if (index2 >= 0 && index2 < this._keys.length) {
              var result2 = this._selector(this._keys[index2], this._values[index2]);
...
// node_modules/vue3-component-base/helpers.ts
var hasOwn = Object.call.bind(Object.prototype.hasOwnProperty);
...
// node_modules/vue3-component-base/index.js
var $internalHooks = /* @__PURE__ */ new Set([
  "beforeCreate",
  "created",
  "beforeMount",
  "mounted",
...
var VueComponentBase = class {
  constructor() {
    return {};
  }
};
var VueInreactive = Symbol("vue-inreactive");
function Inreactive(prototype, prop) {
  pushOrCreate(prototype, VueInreactive, prop);
}
var VueField = Symbol("vue-decorate-field");
...
var Prop = decorateField.bind(null, "props");
var Ref = decorateField.bind(null, "refs");
var Inject = decorateField.bind(null, "injects");
var VueWatches = Symbol("vue-decorate-watch");
function Watch(prop, option) {
  return function decorate(clazz, fn) {
    pushOrCreate(clazz[fn], VueWatches, { prop, option });
  };
}
var VueHooks = Symbol("vue-decorate-hook");
function Component(...mixins) {
  return (clazz) => {
    var _a, _b, _c, _d;
    ...
    const opts = {
      ...
      beforeCreate() {
        Object.defineProperties(this, mapValues_default(refs, (x) => x || { value: [], configurable: false }));
      },
      created() {
    ...
    function addLifeCycleHook(prop, fn) {
      if (prop === "setup") {
        ...
        const mixin3 = opts.mixins[opts.mixins.length - 1];
        if (hasOwn(mixin3, prop)) {
          mixins.push({ [prop]: fn });
        } else {
          mixin3[prop] = fn;
        }
    ...
    const lifeCycleHook = /* @__PURE__ */ new Set();
    for (let proto = prototype; proto && proto !== Object.prototype; proto = Object.getPrototypeOf(proto)) {
      if (hasOwn(proto, VueField)) {
        (_b = proto[VueField].props) === null || _b === void 0 ? void 0 : _b.forEach(([field, config = {}]) => {
          var _a2;
          (_a2 = opts.props)[field] || (_a2[field] = !config.type ? Object.assign({ type: Reflect.getMetadata("design:type", proto, field) }, config) : config);
        });
        (_c = proto[VueField].refs) === null || _c === void 0 ? void 0 : _c.forEach(([field, refKey]) => {
          ...
          refs[field] || (refs[field] = type !== Array ? { get() {
            return this._.refs[refKey || field];
          }, configurable: false } : null);
          if (type === Array) {
            (_a2 = opts.methods)[_b2 = refKey || field + "RefFn"] || (_a2[_b2] = function updateRefField(index2, component) {
              if (component) {
                this[field][index2] = component;
              } else {
                this[field].length--;
              }
            });
      ...
      for (const [property2, descriptor] of Object.entries(Object.getOwnPropertyDescriptors(proto))) {
        ...
        if ($internalHooks.has(property2)) {
          let fn = property2;
          switch (property2) {
            case "beforeDestroy":
          ...
          opts.computed[property2] = opts.computed[property2] || {
            get: descriptor.get,
            set: descriptor.set
          };
        } else {
          ...
          opts.methods[property2] = opts.methods[property2] || descriptor.value;
        }
      }
    }
...
var VCodeMirror = VCodeMirror_1 = class VCodeMirror2 extends VueComponentBase {
  render() {
    return h("div", { class: "v-code-mirror" });
  }
  mounted() {
    const editor = this.editor = markRaw((0, import_codemirror.default)(this.$el, {
      value: this.value,
      mode: this.mode,
    ...
    if (!VCodeMirror_1.ro) {
      VCodeMirror_1.ro = new ResizeObserver_es_default(function(entries) {
...
vue3-component-base/reflect-metadata.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=vue3-code-mirror.js.map
